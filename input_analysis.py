...
if __name__ == "__main__":
    ...
    for app in monthly_costs_app.keys():
        ...
        for index, dt in enumerate(monthly_costs['Date']):
            report['costs'].append( [dt,monthly_costs['TotalCost'][index] ])
    ...
    rendered_file = template.render(repo=report, applications = monthly_costs_app.keys(), monthly_costs=monthly_costs_app, images=images)
